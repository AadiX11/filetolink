    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL is not None:
            try:
                ...
                return
        await m.reply_photo(
            photo="https://telegra.ph/file/2a29865a9aaab000d3abe.jpg",
            caption="**ʜᴇʟʟᴏ...⚡\n\nɪᴀᴍ ᴀ sɪᴍᴘʟᴇ ᴛᴇʟᴇɢʀᴀᴍ ғɪʟᴇ/ᴠɪᴅᴇᴏ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʟɪɴᴋ ᴀɴᴅ sᴛʀᴇᴀᴍ ʟɪɴᴋ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ.**\n\n**ᴜsᴇ /help ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛsɪʟs\n\nsᴇɴᴅ ᴍᴇ ᴀɴʏ ᴠɪᴅᴇᴏ / ғɪʟᴇ ᴛᴏ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀᴢ...**",
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton('⍟ Hᴇʟᴘ ⍟', callback_data='help'), InlineKeyboardButton("⚡ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ⚡", url="https://t.me/MjSupport")],
                    [InlineKeyboardButton("📺 24/7 𝙼𝙾𝚅𝙸𝙴𝚂 📺", url="https://t.me/JunctionsChat"), InlineKeyboardButton("💎 𝙾𝚃𝚃 𝙼𝙾𝚅𝙸𝙴𝚂 💎", url="https://t.me/Movies_Junctions")],
                    [InlineKeyboardButton("💌 𝙼𝙾𝚅𝙸𝙴 𝙱𝙾𝚃 💌", url="https://t.me/MOVIESxSEARCH_BOT")]
                ]
            ),
...
async def help_handler(bot, message):
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("⚡ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 ⚡", url="https://t.me/Movies_Junctions"), InlineKeyboardButton("⚡ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ⚡", url="https://t.me/MjSupport")],
                [InlineKeyboardButton("📺 24/7 𝙼𝙾𝚅𝙸𝙴𝚂 📺", url="https://t.me/Movies_Junctions"), InlineKeyboardButton("💎𝙾𝚃𝚃 𝙼𝙾𝚅𝙸𝙴𝚂💎", url="https://t.me/Movies_Junctions")],
                [InlineKeyboardButton("💌 𝙼𝙾𝚅𝙸𝙴 𝙱𝙾𝚃 💌", url="https://t.me/MOVIESxSEARCH_BOT")]
            ]
        )
    )
...
<b>✯ Mʏ Nᴀᴍᴇ : <a href='https://t.me/File_To_Link_7Bot'>Fɪʟᴇ Tᴏ Lɪɴᴋ</a></b>

<b>✯ Cʜᴀɴɴᴇʟ : <a href='https://t.me/Movies_Junctions'>Mᴏᴠɪᴇꜱ Jᴜɴᴄᴛɪᴏɴꜱ</a></b>

<b>✯ Gʀᴏᴜᴘ : <a href='https://t.me/JunctionsChat'>Jᴜɴᴄᴛɪᴏɴꜱ Cʜᴀᴛ</a></b>

<b>✯ Bᴜɪʟᴅ Sᴛᴀᴛᴜs : ᴠ2.0.1 [Sᴛᴀʙʟᴇ]</b>""",
  
        
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("⚡ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ⚡", url="https://t.me/MjSupport"), InlineKeyboardButton("📺 24/7 𝙼𝙾𝚅𝙸𝙴𝚂 📺", url="https://t.me/Movies_Junctions")],
                [InlineKeyboardButton("💌 𝙼𝙾𝚅𝙸𝙴𝙱𝙾𝚃 💌 ", url="https://t.me/MOVIESxSEARCH_BOT")]
            ]
        )
    )
